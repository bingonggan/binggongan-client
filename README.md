...
또한 **회전**이 가능한 지 확인하였습니다. 물건을 포장할 때 물건을 회전시키면 더 효율적으로 포장할 수 있기 때문입니다.
...
<div align="center">
  <img src="https://github.com/user-attachments/assets/d4fc7c10-d5a4-415d-b702-d17b8d0a78a4" width="300rem"/>
...
> 서버의 계산량이 **물건의 개수**에 비례하여 증가함에 따라 적절한 **물건 개수 제한**을 설정할 필요가 있었습니다.<br> 이를 위해 **서버 부하 테스트**를 실시하였고, **물건 개수를 15개로 제한**하는 것으로 결정하였습니다.
